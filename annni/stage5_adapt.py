...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'results/stage5_v1'
...
def fp():return {f:sha(ROOT/f) for f in ['annni/upgrade_gates.py','annni/stage5_adapt.py','configs/stage5_v1.json','annni/model.py']}
def reference(n,k,h):
 assert h>0
